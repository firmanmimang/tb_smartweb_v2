                ...
                <div class="col-md-4 mb-3">
                    <div class="card" style="height: 100%">
                        <div class="position-absolute px-3 py-2" style="background-color: rgba(0, 0, 0, 0.7)">
                            <a href="/blog?category={{ $p->category->slug }}" class="text-light text-decoration-none">
                                {{ $p->category->name }}
                            </a>
                        </div>
                        @if ($p->image)
                        ...
                        @else
                            <div class="w-100 overflow-hidden" style="height: 150px;">
                                <img src="{{ asset('img/no_image_available.png') }}" class="w-100" alt="{{ $p->category->name }}" style="object-fit: cover; height: 100%;">
                            </div>
                        @endif
                        <div class="card-body text-dark">
                            <h5 class="card-title">{{ $p->title }}</h5>
                            <p>
                                <small class="text-muted">by <a class="text-decoration-none" href="/blog?author={{ $p->author->username }}">{{ $p->author->name }}</a>
